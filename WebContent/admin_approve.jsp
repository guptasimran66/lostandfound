...
<% ArrayList<Product> ProductList = DatabaseQuery.pending(); %>
 <table border="1" cellspacing="2">
	...
	<% for(Product Plist : ProductList) {%>
		<tr>
        	...
        	<td> <a href="Controller?mode=approve&id=<%= Plist.id %>"> <button ><i class="fa fa-check-circle" aria-hidden="true"></i></button></a></td>
        	<td> <a href="Controller?mode=notapprove&id=<%= Plist.id %>"><button><img style="box-shadow:0px 0px 0px 0px rgba(50, 50, 50, 0.75);" src="images/delete.jpg" height="20" alt="Delete"> </button></a></td>
